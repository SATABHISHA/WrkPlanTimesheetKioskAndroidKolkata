...
public class HomeLoginActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        imgbtn_home.setVisibility(View.GONE);
    }
...
//        String loginURL = Config.BaseUrl + "ValidateTSheetLogin";
        ...
        final ProgressDialog loading = ProgressDialog.show(HomeLoginActivity.this, "Authenticating", "Please wait while logging", false, false);
...
//                                            } //as checkbox is not req for kiosk
                                            /*Intent intent = new Intent(HomeLoginActivity.this, AdminHomeActivity.class);
...
//                new org.arb.gst.config.Snackbar(message,v);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(HomeLoginActivity.this);
